...
class recusive_backtracking:
    ...
    def solv_sudoku(self):
        ...
        if rij == False and colom == False and self.sudoku[0][0] != "_":          # 0 == false als index 0,0 == 0 denk het programma dat hij al klaar is daarom die laatste and
